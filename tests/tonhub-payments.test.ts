...
import { ceilTonAmountNanoFromFiat } from "../backend/src/rates";
import {
...
const dependencies = {
  ...
  findRateSnapshot: async () => ({
    id: "test-gram-usd-snapshot",
    asset: "GRAM" as const,
    baseCurrency: "GRAM" as const,
    quoteCurrency: "USD" as const,
    price: "2.47",
    source: "coingecko" as const,
    observedAt: new Date("2026-05-11T09:59:00.000Z"),
...
assert.equal((partial.body.invoice as { paidNano: string }).paidNano, "1010000000");
